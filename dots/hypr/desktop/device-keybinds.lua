...
for i = 6, 9 do
	local ws = i + 5
	hl.bind("CONTROL + " .. i, hl.dsp.focus({ workspace = ws }))
	hl.bind("ALT + " .. i, hl.dsp.focus({ workspace = ws + 5 }))
	hl.bind("CONTROL + SHIFT + " .. i, hl.dsp.window.move({ workspace = ws }))
	hl.bind("ALT + SHIFT + " .. i, hl.dsp.window.move({ workspace = ws + 5 }))
end
