...
ZSH_HIGHLIGHT_STYLES[precommand]=fg=red,bold ZSH_HIGHLIGHT_STYLES[commandseparator]=fg=blue,bold
ZSH_HIGHLIGHT_STYLES[autodirectory]=fg=green,underline
ZSH_HIGHLIGHT_STYLES[path]=fg=none,bold
...
ZSH_HIGHLIGHT_STYLES[comment]=fg=#878286,bold
